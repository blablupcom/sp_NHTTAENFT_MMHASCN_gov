...
entity_id = "NHTTAENFT_MMHASCN_gov"
url = "http://www.mhsc.nhs.uk/about-the-trust/publications-and-reports/publication-of-expenditure-over-£500.aspx"
errors = 0
data = []
...
for block in blocks:
    try:
        if 'csv' in block['href'] or '.xls' in block['href'] or '.xlsx' in block['href'] or '.pdf' in block['href']:
                link = 'http://www.mhsc.nhs.uk'+block['href']
